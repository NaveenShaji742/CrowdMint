...
const FundRiserForm = () => {
    ...
    const riseFund = (e) =>{
       ...
       const onSuccess = () =>{
        ...
        setDeadline("")
        toastSuccess("Fundrising started 🎉");
      }
  ...
  return (
    <>
        ...
        <form onSubmit={(e)=>riseFund(e)}>
            ...
            <button className="p-2 w-full bg-[#F56D91] text-white rounded-md hover:bg-[#d15677]" disabled={btnLoading} >{btnLoading?"Loading...":"Rise Funding"}</button>
        </form>
    </>
  )
}
